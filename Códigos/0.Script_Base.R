...
p_load(
  ...
  dummies,       # Crea variables ficticias (dummies) a partir de datos categóricos.
  ...
  tm,            # Procesamiento y análisis de texto para minería de datos textuales.
  stopwords,     # Manejo de palabras vacías (stopwords) en análisis de texto.
  ...
  patchwork,     # Combinación y diseño de múltiples gráficos en un mismo lienzo.
  Hmisc          # Herramientas avanzadas para análisis estadístico (correlaciones, resumen de datos, etc.).
)
